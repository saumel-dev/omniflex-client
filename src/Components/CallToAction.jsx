          ...
          <div className="group relative flex flex-col justify-between p-8 rounded-2xl bg-default-100/40 dark:bg-white/[0.01] border border-default-200 dark:border-white/5 hover:border-[#FF6B00]/40 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative z-10">
              <Link 
                href="/all_classes"
                underline="none"
                className="inline-flex items-center gap-2 text-xs uppercase font-bold tracking-wider text-[#FF6B00] hover:text-[#E56000] transition-colors"
              >
          ...
          <div className="group relative flex flex-col justify-between p-8 rounded-2xl bg-default-100/40 dark:bg-white/[0.01] border border-default-200 dark:border-white/5 hover:border-[#FF6B00]/40 transition-all duration-300 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Link 
                href="/become-trainer" 
                underline="none"
                className="inline-flex items-center gap-3 bg-[#FF6B00] text-white font-bold text-xs uppercase tracking-wider px-5 py-3 rounded-xl hover:bg-[#E56000] active:scale-[0.98] shadow-md shadow-[#FF6B00]/10 transition-all duration-200"
              >
